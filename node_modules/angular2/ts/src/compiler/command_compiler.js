System.register(['angular2/src/facade/lang', 'angular2/src/facade/collection', 'angular2/src/core/linker/template_commands', './template_ast', './source_module', './util', 'angular2/src/core/di'], function(exports_1) {
    ...
    var lang_1, collection_1, template_commands_1, template_ast_1, source_module_1, util_1, di_1;
    var TEMPLATE_COMMANDS_MODULE_REF, IMPLICIT_TEMPLATE_VAR, CLASS_ATTR, STYLE_ATTR, CommandCompiler, RuntimeCommandFactory, CodegenCommandFactory, CommandBuilderVisitor, DirectiveContext, Expression;
    ...
    return {
        ...
        execute: function() {
            exports_1("TEMPLATE_COMMANDS_MODULE_REF", TEMPLATE_COMMANDS_MODULE_REF = source_module_1.moduleRef("package:angular2/src/core/linker/template_commands" + util_1.MODULE_SUFFIX));
            IMPLICIT_TEMPLATE_VAR = '\$implicit';
            CLASS_ATTR = 'class';
            STYLE_ATTR = 'style';
            CommandCompiler = (function () {
            ...
            exports_1("CommandCompiler", CommandCompiler);
            RuntimeCommandFactory = (function () {
            ...
            CodegenCommandFactory = (function () {
                ...
                CodegenCommandFactory.prototype.createText = function (value, isBound, ngContentIndex) {
                    return new Expression(util_1.codeGenConstConstructorCall(TEMPLATE_COMMANDS_MODULE_REF + 'TextCmd') + "(" + util_1.escapeSingleQuoteString(value) + ", " + isBound + ", " + ngContentIndex + ")");
                };
                CodegenCommandFactory.prototype.createNgContent = function (index, ngContentIndex) {
                    return new Expression(util_1.codeGenConstConstructorCall(TEMPLATE_COMMANDS_MODULE_REF + 'NgContentCmd') + "(" + index + ", " + ngContentIndex + ")");
                };
                CodegenCommandFactory.prototype.createBeginElement = function (name, attrNameAndValues, eventTargetAndNames, variableNameAndValues, directives, isBound, ngContentIndex) {
                    ...
                    return new Expression((util_1.codeGenConstConstructorCall(TEMPLATE_COMMANDS_MODULE_REF + 'BeginElementCmd') + "(" + util_1.escapeSingleQuoteString(name) + ", " + attrsExpression + ", ") +
                ...
                CodegenCommandFactory.prototype.createEndElement = function () {
                    return new Expression(util_1.codeGenConstConstructorCall(TEMPLATE_COMMANDS_MODULE_REF + 'EndElementCmd') + "()");
                };
                CodegenCommandFactory.prototype.createBeginComponent = function (name, attrNameAndValues, eventTargetAndNames, variableNameAndValues, directives, encapsulation, ngContentIndex) {
                    var attrsExpression = codeGenArray(attrNameAndValues);
                    return new Expression((util_1.codeGenConstConstructorCall(TEMPLATE_COMMANDS_MODULE_REF + 'BeginComponentCmd') + "(" + util_1.escapeSingleQuoteString(name) + ", " + attrsExpression + ", ") +
                ...
                CodegenCommandFactory.prototype.createEndComponent = function () {
                    return new Expression(util_1.codeGenConstConstructorCall(TEMPLATE_COMMANDS_MODULE_REF + 'EndComponentCmd') + "()");
                };
                CodegenCommandFactory.prototype.createEmbeddedTemplate = function (embeddedTemplateIndex, attrNameAndValues, variableNameAndValues, directives, isMerged, ngContentIndex, children) {
                    return new Expression((util_1.codeGenConstConstructorCall(TEMPLATE_COMMANDS_MODULE_REF + 'EmbeddedTemplateCmd') + "(" + codeGenArray(attrNameAndValues) + ", " + codeGenArray(variableNameAndValues) + ", ") +
            ...
            CommandBuilderVisitor = (function () {
