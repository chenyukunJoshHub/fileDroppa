System.register(['angular2/src/facade/lang', 'angular2/src/facade/collection', './parse_util', './html_tags'], function(exports_1) {
    ...
    var HtmlTokenType, HtmlToken, HtmlTokenError, HtmlTokenizeResult, $EOF, $TAB, $LF, $FF, $CR, $SPACE, $BANG, $DQ, $HASH, $$, $AMPERSAND, $SQ, $MINUS, $SLASH, $0, $SEMICOLON, $9, $COLON, $LT, $EQ, $GT, $QUESTION, $A, $Z, $LBRACKET, $RBRACKET, $a, $f, $z, $x, $NBSP, CR_OR_CRLF_REGEXP, ControlFlowError, _HtmlTokenizer;
