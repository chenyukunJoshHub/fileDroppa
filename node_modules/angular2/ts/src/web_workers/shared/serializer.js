System.register(["angular2/src/facade/lang", 'angular2/src/facade/exceptions', "angular2/src/facade/collection", "angular2/src/core/render/api", 'angular2/src/web_workers/shared/api', "angular2/src/core/di", 'angular2/src/web_workers/shared/render_proto_view_ref_store', 'angular2/src/web_workers/shared/render_view_with_fragments_store', 'angular2/src/core/metadata/view'], function(exports_1) {
    ...
    var lang_1, exceptions_1, collection_1, api_1, api_2, di_1, render_proto_view_ref_store_1, render_view_with_fragments_store_1, view_1;
        ...
        execute: function() {
            ...
            Serializer = (function () {
                ...
                Serializer.prototype._deserializeRenderTemplate = function (map) {
                    return new api_1.RenderComponentTemplate(map['id'], map['shortId'], this.deserialize(map['encapsulation'], view_1.ViewEncapsulation), this.deserialize(map['commands'], api_2.WebWorkerTemplateCmd), this.deserialize(map['styles'], PRIMITIVE));
                };
            ...
            RENDER_TEMPLATE_CMD_SERIALIZER = new RenderTemplateCmdSerializer();
            RENDER_TEMPLATE_CMD_DESERIALIZERS = [
                function (data) {
